            ...
            <div class="navbar-default sidebar" role="navigation">
                   <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>user/welcome/rute"><i class="fa fa-sitemap fa-fw"></i> User<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
                                    <a href="<?php echo base_url(); ?>user/welcome/inputuser"> Tambah User</a>
                                </li>
                               <li>
                                    <a href="<?php echo base_url(); ?>user/welcome/user">Daftar User</a>
                                </li>
                            </ul>
                        </li>
