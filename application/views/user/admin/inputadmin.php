<div id="page-wrapper">
    <div class ="container-fluid">
        <div class="row">
        <div class="col-lg-12">
        <h1 class="page-header" >Form Admin</h1>
            </div>
            <div class="row">
            <div class="col-lg-12">
            <div class="panel panel-primary">
            <div class="panel-heading">
            Silahkan mengisi admin baru
            </div>
            <div class="panel-body">
            <form action="<?php echo base_url().'user/welcome/tambahAdmin' ?>" method="post">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr class="info">
                            <th>Id Admin</th>
                            <th>:</th>
                            <th><input style="background-color: #adada8" type="text" size=10 name="idAdmin" value="<?=$kodeunik?>" readonly></th>
                        </tr>
                        <tr >
                            <th>Nomer Ktp</th>
                            <th>:</th>
