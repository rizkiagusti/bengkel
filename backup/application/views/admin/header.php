...
<head>
  <title>TRAVEL</title>
  <link rel="shortcut icon" href="<?php echo base_url();?>assets/images/TRAVEL.png"/>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="login-block">
           <form method="post" action="<?php echo base_url();?>admin/user/login/login_form">
            ...
            <div class="form-group">
              ...
              <input type="password" name="password" placeholder="Password" id="password" size="15" class="form-control"/><?php echo form_error('password');?>
            </div>
            <div class="checkbox">
					...
					<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
								...
								<li><a href="<?php echo base_url(); ?>welcome/rute"><span data-hover="Kursus">Daftar Rute</span></a></li>
