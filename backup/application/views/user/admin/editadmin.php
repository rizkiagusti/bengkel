<div id="page-wrapper">
    <div class ="container-fluid">
        <div class="row">
        <div class="col-lg-12">
        <h1 class="page-header" >Form Edit Data Admin</h1>
            </div>
            <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr class="info">
                            <th>Id Admin</th>
                            <th>:</th>
                            <th><input style="background-color: #adada8" type="text" size=5 name="idAdmin" value="<?php echo $no->idAdmin ?>" readonly></th>
                        </tr>
                        <tr >
                            <th>Nomer Ktp</th>
                            <th>:</th>
